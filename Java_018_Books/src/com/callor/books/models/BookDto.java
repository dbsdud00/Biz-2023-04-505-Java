...
public class BookDto {
	 ...
	 *  getter, setter, toString, 생성자 2개 를 모두 지우고 
	 *  변수명 또는 변수의 type을 변경하고 다시 생성하자
	 *  
	 *  변수명을 수정하고, getter, setter 등을 수정해 주어야 하는데
	 *  그러는 과정에서 수정을 빼먹는 상황이 발생할 수 있다.
	 *  
	 *  코드를 refactoring 할 때 가장 많은 문제를 발생시킬수 있다.
	 *  reFactoring 할 때 가장 좋은 것은 최소한의 코드 수정이다.
	 *  
	 */
