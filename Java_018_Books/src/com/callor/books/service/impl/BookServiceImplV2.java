...
public class BookServiceImplV2 implements BookService {
	...
	public void loadBooks() {
		...
		while (scan.hasNext()) {
			...
			// " 1000 " : Integer.valueOf(" 1000 ") -> NumberFormatException
			// 이러한 상황에서 숫자 앞 뒤에 붙어있는 space 를 제거해주어야 한다.
			// 다른변수 = 문자열변수.trim()
			String strPrice = book[DataIndex.BOOK.PRICE].trim(); // 문자열 앞뒤 빈칸 제거
	...
	public void printBookList() {
		...
		System.out.printf("%-3s\t",printTitle[DataIndex.BOOK.PAGES]);
