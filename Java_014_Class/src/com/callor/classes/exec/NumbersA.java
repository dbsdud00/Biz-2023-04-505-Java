...
public class NumbersA {
	public static void main(String[] args) {
		// 기본 자료형(primitive type) 변수 생성 키워드
		...
		// int 형 정수와 Integer 형 정수는 기본 정수 값을 저장하는 
		// 변수의 성질을 갖는다.
		num1 = intNum1;	// Integet type 의 데이터를 int type의 변수에 저장한다.
		intNum1 = num1;	// int type의 데이터를 Integer type의 변수에 저장
		
		/*
		 *  primitive (기본형) 변수에 저장된 테이터를 
