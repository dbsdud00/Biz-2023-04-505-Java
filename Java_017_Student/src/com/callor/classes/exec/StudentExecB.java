...
public class StudentExecB {
	public static void main(String[] args) {
		...
		// 객체를 선언만 할 때, null 값을 저장하여 초기화를 하면
		// 객체 때문에 발생하는 메모리 관련 문제를 조금 줄일 수 있다.
		Scanner fileScan = null;
		
		
		// is 가 try 문 안에 있음 -> 밖에서 사용 불가
//		 try {
...
//		}
		...
		/*
		 *  InputStream 도구
		 *  컴퓨터의 외부(네트워크, 파일 등)로 부터 
		 *  데이터를 메모리로 LOAD 하는데 사용하는 도구들의 부모
		 */
		InputStream is = null;
		...
		fileScan = new Scanner(is); // System.in 대신 is
